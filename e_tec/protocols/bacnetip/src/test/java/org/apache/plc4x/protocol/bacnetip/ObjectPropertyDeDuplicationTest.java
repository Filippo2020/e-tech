...
import org.apache.plc4x.protocol.bacnetip.BACnetObjectsDefinitions.BacNetObject;
    ...
    class JustOutputs {
        ...
        void outputObjectChapters() {
            ...
            for (BacNetObject bacNetObject : bacNetObjects) {
                ...
                assertNull(bacNetObjects, BACNET_OBJECT_TYPE_TYPE_NAME);
            }
        }
        ...
        private void assertNull(List<BacNetObject> bacNetObjects, String bacnetObjectTypeTypeName) {
        }
        ...
        void outputUniqueProperties() {
            propertyToObjectNamesMap.forEach((propertyIdentifier, bacNetObjectNames) -> {
                ...
                assertNull(bacNetObjects, propertyIdentifier);
            });
        }
        ...
        void outputDataConstructedDataChilds() {
            ...
            assertNull(childsOfConstructedData, baCnetConstructedData);
        }

        private void assertNull(Set<String> childsOfConstructedData, ComplexTypeDefinition baCnetConstructedData) {
        }
    }
}
