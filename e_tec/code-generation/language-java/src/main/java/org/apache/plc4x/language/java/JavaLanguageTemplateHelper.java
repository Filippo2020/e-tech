...
public class JavaLanguageTemplateHelper extends BaseFreemarkerLanguageTemplateHelper {
    ...
    private static final String S1="UTF-8";
    private static final String S2="STATIC_CALL";
    private static final String S3="readBuffer.read";
    private static final String S4="length";
    private static final String S5="First argument should be a literal";
    private static final String S6="/*TODO: migrate me*/";
    private static final String S7=").byteValue()";
    private static final String S8=".get(";
    private static final String S9=". Actual type ";
    private static final String SA=", ((Number) ";
    ...
    public String getLanguageTypeNameForTypeReference(TypeReference typeReference, boolean allowPrimitive) {
        ...
        throw new IllegalArgumentException("Unsupported simple type");
    }
    ...
    public String getReadBufferReadMethodCall(SimpleTypeReference simpleTypeReference, String valueString, TypedField field) {
        return S6 + getReadBufferReadMethodCall("", simpleTypeReference, valueString, field);
    }
    ...
    public String getReadBufferReadMethodCall(String logicalName, SimpleTypeReference simpleTypeReference, String valueString, TypedField field) {
        switch (simpleTypeReference.getBaseType()) {
            case BIT:
                String bitType = "Bit";
                return S6 + S3 + bitType + "(\"" + logicalName + "\")";
            case BYTE:
                String byteType = "Byte";
                return S6 + S3 + byteType + "(\"" + logicalName + "\")";
            case UINT:
                ...
                return S6 + S3 + unsignedIntegerType + "(\"" + logicalName + "\", " + simpleTypeReference.getSizeInBits() + ")";
            case INT:
                String integerType;
                ...
                return S6 + S3 + integerType + "(\"" + logicalName + "\", " + simpleTypeReference.getSizeInBits() + ")";
            case FLOAT:
                String floatType = (simpleTypeReference.getSizeInBits() <= 32) ? "Float" : "Double";
                return S6 + S3 + floatType + "(\"" + logicalName + "\", " + simpleTypeReference.getSizeInBits() + ")";
            case STRING:
            case VSTRING:
                return codN(field, simpleTypeReference, logicalName);
            case DATE:
            case DATETIME:
            case TIME:
            case UFLOAT:
    ...
    public String codN(TypedField field, SimpleTypeReference simpleTypeReference, String logicalName){
        String stringType = "String";
                final Term encodingTerm = field.getEncoding().orElse(new DefaultStringLiteral(S1));
                ...
                return S6 + S3 + stringType + "(\"" + logicalName + "\", " + length + ", \"" +
                    encoding + "\")";
    }
    ...
    public String getWriteBufferWriteMethodCall(SimpleTypeReference simpleTypeReference, String fieldName, TypedField field) {
        return S6 + getWriteBufferWriteMethodCall("", simpleTypeReference, fieldName, field);
    }
    ...
    public String getWriteBufferWriteMethodCall(String logicalName, SimpleTypeReference simpleTypeReference, String fieldName, TypedField field, String... writerArgs) {
        ...
        switch (simpleTypeReference.getBaseType()) {
            case BIT:
                return S6 + "writeBuffer.writeBit(\"" + logicalName + "\", (boolean) " + fieldName + "" + writerArgsString + ")";
            case BYTE:
                ByteTypeReference byteTypeReference = (ByteTypeReference) simpleTypeReference;
                return S6 + "writeBuffer.writeByte(\"" + logicalName + "\", ((Number) " + fieldName + S7 + writerArgsString + ")";
            case UINT:
                IntegerTypeReference unsignedIntegerTypeReference = (IntegerTypeReference) simpleTypeReference;
                if (unsignedIntegerTypeReference.getSizeInBits() <= 4) {
                    return S6 + "writeBuffer.writeUnsignedByte(\"" + logicalName + "\", " + unsignedIntegerTypeReference.getSizeInBits() + SA+ fieldName + S7 + writerArgsString + ")";
                } 
                if (unsignedIntegerTypeReference.getSizeInBits() <= 8) {
                    return S6 + "writeBuffer.writeUnsignedShort(\"" + logicalName + "\", " + unsignedIntegerTypeReference.getSizeInBits() + SA+ fieldName + ").shortValue()" + writerArgsString + ")";
                }
                if (unsignedIntegerTypeReference.getSizeInBits() <= 16) {
                    return S6 + "writeBuffer.writeUnsignedInt(\"" + logicalName + "\", " + unsignedIntegerTypeReference.getSizeInBits() + SA+ fieldName + ").intValue()" + writerArgsString + ")";
                }
                if (unsignedIntegerTypeReference.getSizeInBits() <= 32) {
                    return S6 + "writeBuffer.writeUnsignedLong(\"" + logicalName + "\", " + unsignedIntegerTypeReference.getSizeInBits() + SA+ fieldName + ").longValue()" + writerArgsString + ")";
                }
                return S6 + "writeBuffer.writeUnsignedBigInteger(\"" + logicalName + "\", " + unsignedIntegerTypeReference.getSizeInBits() + ", (BigInteger) " + fieldName + "" + writerArgsString + ")";
            case INT:
                IntegerTypeReference integerTypeReference = (IntegerTypeReference) simpleTypeReference;
                if (integerTypeReference.getSizeInBits() <= 8) {
                    return S6 + "writeBuffer.writeSignedByte(\"" + logicalName + "\", " + integerTypeReference.getSizeInBits() + SA+ fieldName + S7 + writerArgsString + ")";
                }
                if (integerTypeReference.getSizeInBits() <= 16) {
                    return S6 + "writeBuffer.writeShort(\"" + logicalName + "\", " + integerTypeReference.getSizeInBits() + SA+ fieldName + ").shortValue()" + writerArgsString + ")";
                }
                if (integerTypeReference.getSizeInBits() <= 32) {
                    return S6 + "writeBuffer.writeInt(\"" + logicalName + "\", " + integerTypeReference.getSizeInBits() + SA+ fieldName + ").intValue()" + writerArgsString + ")";
                }
                if (integerTypeReference.getSizeInBits() <= 64) {
                    return S6 + "writeBuffer.writeLong(\"" + logicalName + "\", " + integerTypeReference.getSizeInBits() + SA+ fieldName + ").longValue()" + writerArgsString + ")";
                }
                return S6 + "writeBuffer.writeBigInteger(\"" + logicalName + "\", " + integerTypeReference.getSizeInBits() + ", BigInteger.valueOf( " + fieldName + ")" + writerArgsString + ")";
            case FLOAT:
            case UFLOAT:
                FloatTypeReference floatTypeReference = (FloatTypeReference) simpleTypeReference;
                if (floatTypeReference.getSizeInBits() <= 32) {
                    return S6 + "writeBuffer.writeFloat(\"" + logicalName + "\", " + floatTypeReference.getSizeInBits() + "," + fieldName + "" + writerArgsString + ")";
                } else if (floatTypeReference.getSizeInBits() <= 64) {
                    return S6 + "writeBuffer.writeDouble(\"" + logicalName + "\", " + floatTypeReference.getSizeInBits() + "," + fieldName + "" + writerArgsString + ")";
                } else {
                    throw new IllegalArgumentException("Unsupported float type");
                }
            case STRING:
            case VSTRING:
                final Term encodingTerm = field.getEncoding().orElse(new DefaultStringLiteral(S1));
                ...
                return S6 + "writeBuffer.writeString(\"" + logicalName + "\", " + length + ", \"" +
    ...
    private String toExpression(Field field, TypeReference resultType, Term term, Function<VariableLiteral, String> variableExpressionGenerator) {
        ...
        if (term instanceof Literal) {
            ...
            throw new IllegalArgumentException("Unsupported Term type " + term.getClass().getName() + S9 + resultType);
        }
    }
    ...
    private String toLiteralTermExpression(Field field, TypeReference resultType, Literal literal, Function<VariableLiteral, String> variableExpressionGenerator, Tracer tracer) {
        ...
        if (literal instanceof NullLiteral) {
            ...
            throw new IllegalArgumentException("Unsupported Literal type " + literal.getClass().getName());
        }
    }
    ...
    private String toUnaryTermExpression(Field field, TypeReference resultType, UnaryTerm unaryTerm, Function<VariableLiteral, String> variableExpressionGenerator, Tracer tracer) {
        ...
        switch (unaryTerm.getOperation()) {
            ...
            case "()":
                ...
                return tracer + "(" + toExpression(field, resultType, a, variableExpressionGenerator) + ")";
            default:
                throw new IllegalArgumentException("Unsupported unary operation type " + unaryTerm.getOperation() + S9 + resultType);
        }
    }
    ...
    private String toBinaryTermExpression(Field field, TypeReference resultType, BinaryTerm binaryTerm, Function<VariableLiteral, String> variableExpressionGenerator, Tracer tracer) {
        ...
        switch (operation) {
            ...
            case "!=":
                ...
                //Try to infer the types of the arguments in this case
    ...
    private String toTernaryTermExpression(Field field, TypeReference resultType, TernaryTerm ternaryTerm, Function<VariableLiteral, String> variableExpressionGenerator, Tracer tracer) {
        ...
        if ("if".equals(ternaryTerm.getOperation())) {
            ...
            throw new IllegalArgumentException("Unsupported ternary operation type " + ternaryTerm.getOperation() + S9 + resultType);
        }
    }
    ...
    private String toVariableParseExpression(Field field, TypeReference resultType, VariableLiteral variableLiteral, List<Argument> parserArguments) {
        ...
        // If we're referencing an implicit field, we need to handle that differently.
            ...
            return toImplicitVariableParseExpression(variableLiteral, tracer);
        }
        // Call a static function in the drivers StaticHelper
        else if (S2.equals(variableLiteral.getName())) {
            return toStaticCallParseExpression(field, variableLiteral, parserArguments, tracer);
        }
        ...
        if (isParserArg) {
            ...
            switch (part) {
                ...
                case "encoding":
                    String encoding = ((StringLiteral) field.getEncoding().orElse(new DefaultStringLiteral(S1))).getValue();
            ...
            if (variableLiteral.getIndex().isPresent()) {
                indexAddon = S8 + variableLiteral.getIndex().orElseThrow() + ")";
            }
    ...
    private String toCastVariableParseExpression(Field field, TypeReference resultType, VariableLiteral variableLiteral, List<Argument> parserArguments, Tracer tracer) {
        ...
        if (arguments.size() != 2) {
            throw new IllegalArgumentException("A CAST expression expects exactly two arguments.");
        }
        VariableLiteral firstArgument = arguments.get(0).asLiteral()
            .orElseThrow(() -> new RuntimeException(S5))
            .asVariableLiteral()
    ...
    private String toImplicitVariableParseExpression(VariableLiteral variableLiteral, Tracer tracer) {
        tracer = tracer.dive("implicit");
        return tracer + variableLiteral.getName();
    }

    private String toStaticCallParseExpression(Field field, VariableLiteral variableLiteral, List<Argument> parserArguments, Tracer tracer) {
        tracer = tracer.dive(S2);
        ...
        if (arguments.isEmpty()) {
            throw new IllegalArgumentException("A STATIC_CALL expression expects at least one argument.");
        }
        // make it as static import with a emitImport so if a static call is present a "utils" package must be present in the import
        ...
        sb.append(")");
        if (variableLiteral.getIndex().isPresent()) {
            //If this is a byte typed field, this needs to be an array accessor instead.
            sb.append(S8).append(variableLiteral.getIndex().orElseThrow()).append(")");
        }
    ...
    private String toFunctionCallParseExpression(Field field, TypeReference resultType, VariableLiteral variableLiteral, List<Argument> parserArguments, Tracer tracer) {
        ...
        if (variableLiteral.getArgs().isPresent()) {
            ...
            Optional<List<Term>> optional = variableLiteral.getArgs();
            if(optional.isPresent()){
                for (Term arg : optional.get()) {
                    if (!firstArg) {
                        sb.append(", ");
                    }
    ...
    private String toVariableSerializationExpression(Field field, TypeReference resultType, VariableLiteral variableLiteral, List<Argument> serialzerArguments) {
        ...
        if (S2.equals(variableLiteral.getName())) {
        ...
        // All uppercase names are not fields, but utility methods.
            ...
            return toGlobalFunctionCallSerializationExpression(field, variableLiteral, serialzerArguments, tracer);
        } else if (isVariableLiteralImplicitField(variableLiteral)) { // If we are accessing implicit fields, we need to rely on a local variable instead.
        ...
        if (isSerializerArg) {
            ...
            return codK(tracer, variableLiteral, field);
        } else {
            return tracer + toVariableExpressionRest(field, resultType, variableLiteral);
        }
    }

    private String codK(Tracer tracer, VariableLiteral variableLiteral, Field field){
        tracer = tracer.dive("type arg");
            String part = variableLiteral.getChild().map(VariableLiteral::getName).orElse("");
            switch (part) {
                case "name":
    ...
    private String toGlobalFunctionCallSerializationExpression(Field field, VariableLiteral variableLiteral, List<Argument> serialzerArguments, Tracer tracer) {
    ...
    private String toStaticCallSerializationExpression(Field field, VariableLiteral variableLiteral, List<Argument> serialzerArguments, Tracer tracer) {
        tracer = tracer.dive(S2);
        StringBuilder sb = new StringBuilder();
        List<Term> arguments = variableLiteral.getArgs().orElseThrow(() -> new RuntimeException("A STATIC_CALL expression needs arguments"));
        if (arguments.isEmpty()) {
    ...
    private String toVariableExpressionRest(Field field, TypeReference resultType, VariableLiteral variableLiteral) {
        ...
        if (variableLiteralName.equals(S4)) {
            tracer = tracer.dive(S4);
            return tracer + variableLiteralName + "()" + ((variableLiteral.getIndex().isPresent() ? S8 + variableLiteral.getIndex().orElseThrow() + ")" : "") +
                variableLiteral.getChild().map(child -> "." + toVariableExpressionRest(field, resultType, child)).orElse(""));
        }
        return tracer + "get" + WordUtils.capitalize(variableLiteralName) + "()" + ((variableLiteral.getIndex().isPresent() ? S8 + variableLiteral.getIndex().orElseThrow() + ")" : "") +
            variableLiteral.getChild().map(child -> "." + toVariableExpressionRest(field, resultType, child)).orElse(""));
    }
        ...
        for (Field field : complexTypeDefinition.getFields()) {
            if (field instanceof ArrayField) {
                ...
                if (field instanceof ManualField) {
                    ...
                    codX(simpleTypeReference, sb, sizeInBits, parserArguments);
                }
            }
        }
    ...
    public void codX(SimpleTypeReference simpleTypeReference, StringBuilder sb, int sizeInBits, List<Argument> parserArguments){
