...
public abstract class FreemarkerLanguageOutput implements LanguageOutput {
    ...
    private static final String S1="languageName";
    private static final String S2="protocolName";
    private static final String S3="outputFlavor";
    private static final String S4="helper";
    ...
    public void generate(File outputDir, String version, String languageName, String protocolName, String outputFlavor, Map<String, TypeDefinition> types,
        ...
        try {
            ...
            miscTemplateList = getMiscTemplates();
        } catch (IOException e) {
        ...
        if (!specTemplates.isEmpty()) {
            ...
            typeContext.put(S1, languageName);
            typeContext.put(S2, protocolName);
            typeContext.put(S3, outputFlavor);
            typeContext.put(S4, getHelper(null, protocolName, outputFlavor, types, options));
        ...
        for (Map.Entry<String, TypeDefinition> typeEntry : types.entrySet()) {
            ...
            typeContext.put(S4, getHelper(typeEntry.getValue(), protocolName, outputFlavor, types, options));
    ...
    protected List<Template> getMiscTemplates() {
