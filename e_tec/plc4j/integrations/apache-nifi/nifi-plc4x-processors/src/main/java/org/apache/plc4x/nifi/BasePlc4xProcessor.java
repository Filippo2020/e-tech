...
public abstract class BasePlc4xProcessor extends AbstractProcessor {
    ...
    protected void init(final ProcessorInitializationContext context) {
    	final List<PropertyDescriptor> properties1 = new ArrayList<>();
    	properties1.add(PLC_CONNECTION_STRING);
        this.properties = Collections.unmodifiableList(properties1);

    	final Set<Relationship> relationships1 = new HashSet<>();
        relationships1.add(REL_SUCCESS);
        relationships1.add(REL_FAILURE);
        this.relationships = Collections.unmodifiableSet(relationships1);
    }
