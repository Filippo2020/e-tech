...
public class Plc4xSinkProcessor extends BasePlc4xProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try(PlcConnection connection = getDriverManager().getConnection(getConnectionString())) {
            ...
            flowFile.getAttributes().forEach((tag, value) -> {
                ...
                if (address != null) {
                    // Convert the String into the right type ...
            ...
            nested(writeRequest, session, flowFile);
    ...
    public void nested(PlcWriteRequest writeRequest, ProcessSession session, FlowFile flowFile) throws ExecutionException, InterruptedException{
        try {
            writeRequest.execute().get();
            // Evaluate the response and create flow files for successful and unsuccessful updates
