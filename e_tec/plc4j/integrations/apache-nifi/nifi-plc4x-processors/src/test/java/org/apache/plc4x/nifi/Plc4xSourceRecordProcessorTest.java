...
class Plc4xSourceRecordProcessorTest {
    ...
    @Test
     void testMockRecordWriterProcessor() throws InitializationException {
    ...
    @Disabled("Disabled for now")
     void testJsonRecordWriterProcessor() throws InitializationException {
    ...
    @Test
    @Disabled("Disabled for now")
    void testAvroRecordWriterProcessor() throws InitializationException {
