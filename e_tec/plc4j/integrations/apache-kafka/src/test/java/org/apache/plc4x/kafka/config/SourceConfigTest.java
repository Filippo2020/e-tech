...
class SourceConfigTest {
    ...
    @Test
    void validateConfig() throws Exception{
    ...
    @Test
    void validateExampleConfigFile() throws Exception{
    ...
    @Test
    void validateExampleConfigFile2() throws Exception{
    ...
    @Test
    void checkConnectorClass() throws Exception {
    ...
    @Test
    void checkConnectorStartStop() throws Exception {
    ...
    @Test
    void checkVersionString() throws Exception {
