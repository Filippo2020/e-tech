...
public class Plc4xSourceTask extends SourceTask {
        ...
        try {
            ...
            scraper = new TriggeredScraperImpl(scraperConfig, (jobName, sourceName, results) -> {
                try {
                    ...
                    for (Map.Entry<String, Object> result : results.entrySet()) {
                        cod2(result, tagStruct, tagSchema);
                    }
    ...
    public void cod1(Map.Entry<String, Object> result, SchemaBuilder tagSchemaBuilder){
    ...
    public void cod2(Map.Entry<String, Object> result, Struct tagStruct, Schema tagSchema){
        // Get tag-name and -value from the results.
        String tagName = result.getKey();
        Object tagValue = result.getValue();
    ...
    private Schema cod2(Object value){
