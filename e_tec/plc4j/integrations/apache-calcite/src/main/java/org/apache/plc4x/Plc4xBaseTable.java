...
public abstract class Plc4xBaseTable extends AbstractTable {
    ...
    protected Plc4xBaseTable(BlockingQueue<Plc4xSchema.Record> queue, JobConfiguration conf, long tableCutoff) {
            ...
            public Enumerator<Object[]> enumerator() {
                return new Enumerator<Object[]>() {
                    ...
                    public Object[] current() {
                        ...
                        List<Object> objects2 = names.stream().map(current.values::get).collect(Collectors.toList());
