    ...
    static {
        ...
        if(SystemUtils.IS_OS_WINDOWS) {
            try {
                ...
                processBuilder.command("C:\\Windows\\System32\\systeminfo", "/fo", "CSV", "/nh");
            ...
            //real path : "/sys/devices/virtual/dmi/id/product_name"
            File productNameFile = new File("nonhardcodedpath");
