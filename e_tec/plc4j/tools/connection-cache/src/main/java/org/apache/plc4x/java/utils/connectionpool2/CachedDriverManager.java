...
public class CachedDriverManager extends PlcDriverManager implements CachedDriverManagerMBean {
    ...
    public CachedDriverManager(String url, PlcConnectionFactory connectionFactory) throws PlcConnectionException {
     ...
     */
    public CachedDriverManager(String url, PlcConnectionFactory connectionFactory, int timeoutMillis) throws PlcConnectionException {
        ...
        try {
            ...
            throw new PlcConnectionException(ignore);
        }
    }
     ...
     * Private Impl.
     */
    private synchronized PlcConnection getConnection1(String url) throws PlcConnectionException {
    ...
    private synchronized void checkQueue() {
        ...
        while ((next = queue.poll()) != null) {
            ...
            try {
                next.complete(getConnection1(url));
                return;
