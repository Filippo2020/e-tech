...
public class PlcEntityInterceptor {
    private static final String FRA_SE = " on connected PlcEntity";

    private static final Logger LOGGER = LoggerFactory.getLogger(PlcEntityInterceptor.class);
    private static final  String S1="Problem during processing";
    private static final  String S3="Unable to forward invocation ";
    ...
    public static Object interceptGetter(@This Object proxy, @Origin Method method, @SuperCall Callable<?> callable,
        ...
        if (method.getName().startsWith("get")) {
            ...
            try {
                ...
                throw new OPMException(S3 + method.getName() + FRA_SE, e);
            }
        }
    ...
    public static Object interceptSetter(@This Object proxy, @Origin Method method, @SuperCall Callable<?> callable,
        ...
        if (method.getName().startsWith("set")) {
            ...
            return setValueForSetter(method, callable, driverManager, address, registry, lastFetched, argument);
        }
    ...
    private static Object setValueForSetter(Method m, Callable<?> callable, PlcDriverManager driverManager,
     ...
     */
    static void setField(Class<?> clazz, Object o, PlcReadResponse response, String targetTagName, String sourceTagName){
