...
public class PlcEntityManagerTest implements WithAssertions {
    ...
    class Read {
        ...
        @Test
         void throwsInvalidTagException_rethrows() throws PlcConnectionException {
            // Prepare the Mock
        ...
        @Test
         void unableToConnect_rethrows() throws PlcConnectionException {
            // Prepare the Mock
        ...
        @Test
         void timeoutOnGet_throwsException() throws PlcConnectionException {
            // Prepare the Mock
        ...
        @Test
         void uninstantiableEntity_throws() {
        ...
        @Test
         void resolveAlias_works() throws OPMException, PlcConnectionException {
            ...
            verify(mockDevice).read("real_tag");
        }


        @Test
         void unknownAlias_throws() {
            PlcEntityManager entityManager = new PlcEntityManager();
    ...
    class Write {
        ...
        void simpleWrite() throws Exception {
            ...
            verify(mockDevice, times(0)).read("real_tag");
            ...
            // Assert that "tag" was queried
            verify(mockDevice, times(1)).read("real_tag");
    ...
    class Lifecycle {
         ...
         */
        @Test
        void connect_uninstantiableEntity_throws() {
            PlcEntityManager entityManager = new PlcEntityManager();
        ...
        @Test
        void connect_resolveAlias_works() throws PlcConnectionException, OPMException {
            SimpleAliasRegistry registry = new SimpleAliasRegistry();
            registry.register("alias", "real_tag");
