...
class PlcEntityManagerComplexTest implements WithAssertions {

    private PlcDriverManager driverManager;

    @Test
     void noEntity_throws() {
    ...
    @Test
     void noValidConstructor_throws() {
        PlcEntityManager manager = new PlcEntityManager();
    ...
    @Test
    void read() throws OPMException, PlcConnectionException {
    ...
    @Disabled("Sebastian please fix this")
     void readComplexObject() throws PlcConnectionException, OPMException {
    ...
    @Test
    @Disabled("Sebastian please fix this")
     void connect_callComplexMethod() throws PlcConnectionException, OPMException {
        PlcEntityManager manager = getInitializedEntityManager();
    ...
    private PlcEntityManager getInitializedEntityManager() throws PlcConnectionException {
        ...
        map.put(prefix + "boolVar", PlcValueHandler1.of(true));
        map.put(prefix + "byteVar", PlcValueHandler1.of((byte) 1));
        map.put(prefix + "shortVar", PlcValueHandler1.of((short) 1));
        map.put(prefix + "intVar", PlcValueHandler1.of(1));
        map.put(prefix + "longVar", PlcValueHandler1.of(1L));
        map.put(prefix + "boxedBoolVar", PlcValueHandler1.of(1L));
        map.put(prefix + "boxedByteVar", PlcValueHandler1.of((byte) 1));
        map.put(prefix + "boxedShortVar", PlcValueHandler1.of((short) 1));
        map.put(prefix + "boxedIntegerVar", PlcValueHandler1.of(1));
        map.put(prefix + "boxedLongVar", PlcValueHandler1.of(1L));
        map.put(prefix + "bigIntegerVar", PlcValueHandler1.of(BigInteger.ONE));
        map.put(prefix + "floatVar", PlcValueHandler1.of(1f));
        map.put(prefix + "doubleVar", PlcValueHandler1.of(1d));
        map.put(prefix + "bigDecimalVar", PlcValueHandler1.of(BigDecimal.ONE));
        map.put(prefix + "localTimeVar", PlcValueHandler1.of(LocalTime.of(1, 1)));
        map.put(prefix + "localDateVar", PlcValueHandler1.of(LocalDate.of(1, 1, 1)));
        map.put(prefix + "localDateTimeVar", PlcValueHandler1.of(LocalDateTime.of(1, 1, 1, 1, 1)));
        map.put(prefix + "byteArrayVar", PlcValueHandler1.of(new Byte[]{0x0, 0x1}));
        map.put(prefix + "bigByteArrayVar", PlcValueHandler1.of(new Byte[]{0x0, 0x1}));
        map.put(prefix + "stringVar", PlcValueHandler1.of("Hallo"));
        return getPlcEntityManager(map);
    }

    @Test
    @Disabled("Sebastian please fix this")
     void connect_callGetter() throws PlcConnectionException, OPMException {
        PlcEntityManager manager = getInitializedEntityManager();
    ...
    @Test
    @Disabled("Sebastian please fix this")
     void disconnect() throws PlcConnectionException, OPMException, IllegalAccessException {
        PlcEntityManager manager = getInitializedEntityManager();
    ...
    @Test
    @Disabled("Sebastian please fix this")
     void disconnectTwice_throwsException() throws PlcConnectionException, OPMException {
        PlcEntityManager manager = getInitializedEntityManager();
