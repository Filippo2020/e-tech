...
@ExtendWith(MockitoExtension.class)
 class PlcEntityInterceptorTest implements WithAssertions {
    ...
    @Test
     void getPlcReadResponse_catchesInterruptedException_rethrows() throws InterruptedException {
    ...
    @Test
     void getPlcReadResponse_catchesExecutionException_rethrows() {
    ...
    @Test
     void getPlcReadResponse_timeoutOnGet_rethrows() {
    ...
    @Test
     void getTyped_notOkResponse_throws() {
    ...
    @Test
     void getterWithNoField() throws OPMException {
