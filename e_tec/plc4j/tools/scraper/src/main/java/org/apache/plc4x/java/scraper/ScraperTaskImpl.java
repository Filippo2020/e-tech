...
public class ScraperTaskImpl implements ScraperTask {
        ...
        try {
            CompletableFuture<PlcConnection> future = CompletableFuture.supplyAsync(() -> {
                try {
                    ...
                    throw new PlcRuntimeException("Unable to instantiate connection to " + connectionString,e);
                }
            }, handlerService);
            ...
            PlcReadResponse plcReadResponse = nested(connection);
    ...
    public PlcReadResponse nested(PlcConnection connection) throws InterruptedException, TimeoutException{
