...
@MockitoSettings(strictness = Strictness.LENIENT)
 class ScraperTaskTest implements WithAssertions {

    @Mock
    MockDevice mockDevice;

    @Test
    void scrape() throws PlcConnectionException {
    ...
    class Exceptions {
        ...
        @Test
        void badResponseCode_shouldHandleException() throws PlcConnectionException {
            // Given
            PlcDriverManager driverManager = new PlcDriverManager();
            MockConnection connection = (MockConnection) driverManager.getConnection("mock:scraper");
            connection.setDevice(mockDevice);
        ...
        @Test
        void handleConnectionException() throws PlcConnectionException {
            // Given
