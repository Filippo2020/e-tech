 ...
 */
@Disabled
public class TestManualS7PlcDriverMT {
...
//    public static final String TAG_STRING = "%DB3:DBD32:DINT";
    ...
    void scheduledLoop(int period) throws InterruptedException {
        PlcDriverManager plcDriverManager = new PooledPlcDriverManager();
    ...
    @Test
    void parallelScheduledLoop() throws InterruptedException {
        int period = 5;
        PlcDriverManager plcDriverManager = new PooledPlcDriverManager();
        ScheduledExecutorService executorService = Executors.newScheduledThreadPool(10);
    ...
    void scheduledCancellingLoop(int period, int numberOfRuns) throws InterruptedException, PlcConnectionException {
...
//                System.out.println("Setting a request / guard...");
                CompletableFuture<Double> requestFuture = CompletableFuture.supplyAsync(
                    () -> TestManualS7PlcDriverMT.this.runSingleRequest(plcDriverManager)
                );
        ...
        executorService.awaitTermination(100, TimeUnit.SECONDS);
        // Print statistics
        TestManualS7PlcDriverMT.this.printStatistics(statistics);
