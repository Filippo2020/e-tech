...
public class FxmlController {
    ...
    @FXML
    public void initialize() throws PlcConnectionException {
    ...
    public void cod1(MouseEvent mouseEvent, TreeEntry selectedItem){
        if(mouseEvent.getButton().equals(MouseButton.PRIMARY) && mouseEvent.getClickCount() == 2) {
            ...
            } catch (IOException|PlcConnectionException e) {
    ...
    @FXML
    public void handleBrowseButtonClicked(ActionEvent actionEvent) throws PlcConnectionException {
        MultipleSelectionModel<TreeItem<TreeEntry>> selectionModel = plcTreeView.getSelectionModel();
        if(!selectionModel.getSelectedItems().isEmpty()) {
