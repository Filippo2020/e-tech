...
public class PooledPlcDriverManager extends PlcDriverManager {
        ...
        return (PlcConnection) Proxy.newProxyInstance(classLoader, new Class[]{PlcConnection.class}, (proxy, method, args) -> {
            ...
            if ("close".equals(method.getName())) {
                ...
                try {
                    ...
                    cod1(e, poolKey, plcConnection, proxyInvalidated);
                    throw e;
                }
            }
        });
    ...
    public void cod1(InvocationTargetException e, PoolKey poolKey, PlcConnection plcConnection, AtomicBoolean proxyInvalidated) throws Exception{
    ...
    //maybe export to jmx // generic poolKey has builtin jmx too
