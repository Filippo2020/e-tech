...
class PlcDriverManagerTest {
     ...
     */
    @Test
    void getInvalidUriTest() throws PlcConnectionException {
        assertThrows(PlcConnectionException.class,
     ...
     */
    @Test
    void getDuplicateDriver() throws MalformedURLException {
        ...
        assertThrows(IllegalStateException.class,
            () -> new PlcDriverManager(fakeClassLoader));    
    }
