...
public abstract class CANOpenConversationBase {
    ...
    protected CANOpenConversationBase(CANConversation delegate, int nodeId, int answerNodeId) {
    ...
    protected <X extends SDOResponse> Either<SDOAbort, X> unwrap(Class<X> payload, SDOResponse response) {
        ...
        throw new IllegalArgumentException("Unexpected payload kind " + response);
    }
