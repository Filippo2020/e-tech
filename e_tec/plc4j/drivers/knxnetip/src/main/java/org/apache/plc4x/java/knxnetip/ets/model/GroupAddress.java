...
public class GroupAddress {
    ...
    private final String groupAddressz;
    private final String name;
    private final KnxDatapointType type;
    private final Function function;

    public GroupAddress(String groupAddressz, String name, KnxDatapointType type, Function function) {
        this.groupAddressz = groupAddressz;
        this.name = name;
        this.type = type;
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
            .append("groupAddress", groupAddressz)
            .append("name", name)
            .append("type", type)
