...
class Ets6FileHandlerTest {
    ...
    void getProcessedPasswordA() {
        ...
        assertEquals("+FAwP4iI7/Pu4WB3HdIHbbFmteLahPAVkjJShKeozAA=",processedPassword);
    }
    ...
    void getProcessedPasswordTest() {
        ...
        assertEquals("2+IIP7ErCPPKxFjJXc59GFx2+w/1VTLHjJ2duc04CYQ=",processedPassword);
    }
    ...
    void getProcessedPasswordPennywise() {
        ...
        assertEquals("ZjlYlh+eTtoHvFadU7+EKvF4jOdEm7WkP49uanOMMk0=",processedPassword);
    }
