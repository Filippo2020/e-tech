...
public class Plc4XSupportedDataTypes {
    ...
    private Plc4XSupportedDataTypes() {
    ...
    public static class DataTypePair<T extends Serializable> {
        private final Pair<T, byte[]> dataTypePair1;

        public DataTypePair(Pair<T, byte[]> dataTypePair) {
            this.dataTypePair1 = dataTypePair;
        }
         ...
         */
        public T getValue() {
            return SerializationUtils.clone(dataTypePair1.getLeft());
        }
        ...
        public Class<?> getDataTypeClass() {
            return dataTypePair1.getLeft().getClass();
        }
        ...
        public byte[] getByteRepresentation() {
            return ArrayUtils.clone(dataTypePair1.getRight());
        }
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(dataTypePair1, that.dataTypePair1);
        }

        @Override
        public int hashCode() {
            return Objects.hash(dataTypePair1);
        }

        @Override
        public String toString() {
            return "DataTypePair{" +
                "dataTypePair=" + dataTypePair1 +
                '}';
        }
    }
}
