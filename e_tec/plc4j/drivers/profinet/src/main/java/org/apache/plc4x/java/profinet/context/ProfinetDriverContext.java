...
public class ProfinetDriverContext  implements DriverContext, HasConfiguration<ProfinetConfiguration> {
    ...
    private DceRpc_ActivityUuid dceRpcActivityUuid;
    ...
    public DceRpc_ActivityUuid getDceRpcActivityUuid() {
        return dceRpcActivityUuid;
    }

    public void setDceRpcActivityUuid(DceRpc_ActivityUuid dceRpcActivityUuid) {
        this.dceRpcActivityUuid = dceRpcActivityUuid;
    }
