...
public class StaticHelper {
    ...
    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger(StaticHelper.class);
        int n1=calculateIPv4Checksum(532, 0x44DF, 64,
        ...
        int n2=calculateIPv4Checksum(198, 0x0048, 30,
            new IpAddress(new byte[]{(byte) 0xC0, (byte) 0xA8, (byte) 0x18, (byte) 0x1F}),
            new IpAddress(new byte[]{(byte) 0xC0, (byte) 0xA8, (byte) 0x18, (byte) 0xC8}));
            if(logger.isInfoEnabled()){
             logger.info(Integer.toString(n1));
             logger.info(Integer.toString(n2));
            }
    }
    ...
    public static PnDcp_FrameId cod1(int frameIdValue){
        // Range 1
