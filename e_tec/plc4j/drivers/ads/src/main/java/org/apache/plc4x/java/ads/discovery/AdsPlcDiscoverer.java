...
public class AdsPlcDiscoverer implements PlcDiscoverer {
 ...
 static Logger logger = LoggerFactory.getLogger(AdsPlcDiscoverer.class);
                ...
                if (!networkInterface.isLoopback()) {
                    for (InterfaceAddress interfaceAddress : networkInterface.getInterfaceAddresses()) {
                        if ((interfaceAddress.getBroadcast() != null) && (interfaceAddress.getAddress() instanceof Inet4Address)) {
                                    ...
                                    while (true) {
                                        ...
                                        if ((adsDiscoveryResponse.getRequestId() == 0) &&
                                            ...
                                            if (hostNameBlock != null) {
                                                ...
                                                //Check if this is legit, or if we can get the information from somewhere.
                                                ...
                                                if (versionBlock != null) {
                                                    ...
                                                    attributes.put("twinCatVersion", new PlcSTRING(String.format("%d.%d.%d",versionData[0] & 0xFF, versionData[1] & 0xFF, patchVersion)));
                                                }
                                                if (fingerprintBlock != null) {
                                                    attributes.put("fingerprint", new PlcSTRING(new String(fingerprintBlock.getData())));
                                                }
                                                //Find out how to handle the OS Data
                            ...
                            nested2(inet4Address, interfaceAddress, adsDiscoverySocket);
    ...
    public void nested2(Inet4Address inet4Address, InterfaceAddress interfaceAddress, DatagramSocket adsDiscoverySocket){
        try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Logger logg = LoggerFactory.getLogger(AdsPlcDiscoverer.class);
        ...
        if(logg.isInfoEnabled()){
         String format = "message{}" + (plcDiscoveryResponse).toString();
         logg.info(format);
        }
    }
