...
public class GenericCANProtocolLogic extends Plc4xCANProtocolBase<GenericFrame> implements PlcSubscriber {
    ...
    public void setContext(ConversationContext<GenericFrame> context) {
        ...
        this.tm = new RequestTransactionManager(4);
    }
    ...
    @Override
    public void decode(ConversationContext<GenericFrame> context, GenericFrame msg) {
        try{
    ...
    public void nested(ReadBuffer buffer, Entry<String, GenericCANTag> tag, Map<String, ResponseItem<PlcValue>> tags){
        try {
    ...
    public CompletableFuture<PlcWriteResponse> write(PlcWriteRequest writeRequest) {
        ...
        transaction.submit(() -> {
            ...
            write1(messages, responses, codes);
    ...
    public void write1(Map<Integer, WriteBufferByteBased> messages, Map<Integer, Map<String, PlcResponseCode>> responses, Map<String, PlcResponseCode> codes ){
