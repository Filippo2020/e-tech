...
public class ModbusRtuDriver extends GeneratedDriverBase<ModbusRtuADU> {
    ...
    @Override
    public ProtocolStackConfigurer<ModbusRtuADU> getStackConfigurer() {
        return SingleProtocolStackConfigurer.builder(ModbusRtuADU.class,
                (io, args) -> (ModbusRtuADU) org.apache.plc4x.java.modbus.readwrite.ModbusADU.staticParse(io, args))
