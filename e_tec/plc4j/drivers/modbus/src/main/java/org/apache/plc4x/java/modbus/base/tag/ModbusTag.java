...
public abstract class ModbusTag implements PlcTag, Serializable {
    ...
    public void serialize(WriteBuffer writeBuffer) throws SerializationException {
        ...
        String dataType1 = getDataType().name();
        writeBuffer.writeString("dataType", dataType1.getBytes(StandardCharsets.UTF_8).length * 8, StandardCharsets.UTF_8.name(), dataType1);
