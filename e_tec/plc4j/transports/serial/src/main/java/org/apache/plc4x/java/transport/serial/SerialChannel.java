...
public class SerialChannel extends AbstractNioByteChannel implements DuplexChannel {
    ...
    public static final String S1="Unable to flush";
    private final VoidChannelPromise unsafeVoidPromise = new VoidChannelPromise(this, false);
    private SocketAddress remoteAddress;
    private boolean active = false;
    private SerialSelectionKey selectionKey1;
    ...
    protected boolean doConnect(SocketAddress remoteAddress, SocketAddress localAddress) throws Exception {
        ...
        try {
            ...
            if (comPort.open()) {
                ...
                comPort.registerSelectionKey(selectionKey1);
    ...
    private class SerialNioUnsafe implements NioUnsafe {
        ...
        public SerialNioUnsafe() {
            try {
                ...
                throw new IllegalArgumentException("Problem providing Buffer", e);
            }
        }
        ...
        public void read() {
            ...
            final ChannelPipeline pipeline1 = pipeline();
            ...
            try {
                do {
                    ...
                    pipeline1.fireChannelRead(byteBuf);
                ...
                String format = "An error occurre" + t;
                logger.info(format);
            } finally {
        ...
        public void register(EventLoop eventLoop, ChannelPromise promise) {
            ...
            try {
                ...
                selectionKey1 = (SerialSelectionKey) ((SerialChannel) promise.channel()).javaChannel().register(selector, 0, SerialChannel.this);

                // Set selection key
                final Field selectionKeyField = AbstractNioChannel.class.getDeclaredField("selectionKey");
                selectionKeyField.setAccessible(true);
                selectionKeyField.set(SerialChannel.this, selectionKey1);
        ...
        public void write(Object msg, ChannelPromise promise) {
            ...
            ChannelOutboundBuffer outboundBuffer1 = this.outboundBuffer;
            if (outboundBuffer1 == null) {
                ...
                throw new IllegalArgumentException("Unable to write", initialCloseCause);
            }
            ...
            try {
                ...
                close(voidPromise());
                ReferenceCountUtil.release(msg);
                throw new IllegalArgumentException("Problem during write", t);
            }

            outboundBuffer1.addMessage(msg, size, promise);
        }
        ...
        protected void flush0() {
            ...
            final ChannelOutboundBuffer outboundBuffer3 = this.outboundBuffer;
            if (outboundBuffer3 == null || outboundBuffer3.isEmpty()) {
                return;
            }
            ...
            try {
                ...
                if (t instanceof IOException && config().isAutoClose()) {
                    ...
                    initialCloseCause = t;
                    close(voidPromise());
                    throw new IllegalArgumentException(S1, t);
                } else {
                    try {
