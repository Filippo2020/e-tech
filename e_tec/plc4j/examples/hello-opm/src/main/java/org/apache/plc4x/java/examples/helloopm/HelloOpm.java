...
public class HelloOpm {
    ...
    private static final Logger logger = LoggerFactory.getLogger(HelloOpm.class);
    ...
    public void readValueFromPlcUsingConnectedEntity() throws OPMException {
        ...
        long distance = distanceSensor.getDistance();
         try {
            throw new IllegalAccessException("Current distance: " + distance);
    ...
    public void readValueFromPlcUsingRead() throws OPMException {
        ...
        try {
            throw new IllegalAccessException("Current distance: " + distanceSensor.getDistance());
        } catch (IllegalAccessException e) {
            String palle = "error: " + e;
            logger.info(palle);
        }
