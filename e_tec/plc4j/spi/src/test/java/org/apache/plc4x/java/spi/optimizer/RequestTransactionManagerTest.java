...
class RequestTransactionManagerTest {

    private static final Logger logger = LoggerFactory.getLogger(RequestTransactionManagerTest.class);

    @Test
    void simpleExample() throws ExecutionException, InterruptedException {
    ...
    @Test
    void exampleWithMultipleRequests() throws ExecutionException, InterruptedException {
    ...
    @Test
    void version2() throws ExecutionException, InterruptedException {
        CompletableFuture<Void> sendRequest = new CompletableFuture<>();
        CompletableFuture<Void> receiveResponse = new CompletableFuture<>();
        CompletableFuture<Void> transactionIsFinished = new CompletableFuture<>();
...
//        handle.failRequest(new RuntimeException());
    ...
    void abortTransactionFromExternally() throws ExecutionException, InterruptedException {
        CompletableFuture<Void> sendRequest = new CompletableFuture<>();
        CompletableFuture<Void> receiveResponse = new CompletableFuture<>();
        CompletableFuture<Void> transactionIsFinished = new CompletableFuture<>();
