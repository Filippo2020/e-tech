...
public class FieldReaderPeek<T> implements FieldCommons {
    ...
    public T readPeekField(String logicalName, DataReader<T> dataReader, WithReaderArgs... readerArgs) throws ParseException {
        int curPos = dataReader.getPos();
        try {
            // implement offset. We either need to pass the readBuffer or add a instruction to the dataReader
