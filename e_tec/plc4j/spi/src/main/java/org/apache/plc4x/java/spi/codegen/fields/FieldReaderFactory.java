...
public class FieldReaderFactory {
    private FieldReaderFactory() {
        throw new IllegalStateException("Utility class");
    }
    @SuppressWarnings("unused")
    public static <T> T readAbstractField(String logicalName, DataReader<T> dataReader, WithReaderArgs... readerArgs){
        return new FieldReaderAbstract<T>().readAbstractField();
    }

    //only used as lazy workaround
    /**
     * @deprecated
     */
    @Deprecated
    ...
    public static <T> void readPaddingField(DataReader<T> dataReader, int timesPadding, WithReaderArgs... readerArgs){
    ...
    public static <T> T readVirtualField(String logicalName, Class<T> type, Object valueExpression, WithReaderArgs... readerArgs) {
    ...
    public static <T> T readPeekField(String logicalName, DataReader<T> dataReader, WithReaderArgs... readerArgs) throws ParseException {
        return new FieldReaderPeek<T>().readPeekField(logicalName, dataReader, readerArgs);
    }
