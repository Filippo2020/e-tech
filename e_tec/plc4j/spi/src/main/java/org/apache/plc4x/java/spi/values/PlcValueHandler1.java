...
public class PlcValueHandler1 implements org.apache.plc4x.java.api.value.PlcValueHandler {
    ...
    public static PlcValue of(Object[] values) {
        ...
        return conditionRefactor(value);
    }

    public static PlcValue conditionRefactor(Object value){
        ...
        if (value instanceof LocalTime) {
            return new PlcTimeOfDay((LocalTime) value);
        }
        if (value instanceof LocalDate) {
            return new PlcDATE((LocalDate) value);
        }
        if (value instanceof LocalDateTime) {
            return new PlcDateAndTime((LocalDateTime) value);
        }
    ...
    public static PlcValue of(PlcTag tag, Object[] values) {
        if (values.length == 1) {
            ...
            return switchCaseRefactor(tag, value);
        } else {
            PlcList list = new PlcList();
            for (Object value : values) {
    ...
    public static PlcValue switchCaseRefactor(PlcTag tag, Object value){
        switch (tag.getPlcValueType()) {
            ...
            case TIME_OF_DAY:
                return PlcTimeOfDay.of(value);
            case DATE_AND_TIME:
                return PlcDateAndTime.of(value);
            default:
