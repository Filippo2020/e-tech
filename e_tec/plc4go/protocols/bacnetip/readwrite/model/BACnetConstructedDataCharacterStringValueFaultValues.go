...
func (m *_BACnetConstructedDataCharacterStringValueFaultValues) GetLengthInBits() uint16 {
	return m.GetLengthInBitsConditional(false)
}

func (m *_BACnetConstructedDataCharacterStringValueFaultValues) GetLengthInBitsConditional(lastItem bool) uint16 {
...
func (m *_BACnetConstructedDataCharacterStringValueFaultValues) GetLengthInBytes() uint16 {
...
func BACnetConstructedDataCharacterStringValueFaultValuesParse(theBytes []byte, tagNumber uint8, objectTypeArgument BACnetObjectType, propertyIdentifierArgument BACnetPropertyIdentifier, arrayIndexArgument BACnetTagPayloadUnsignedInteger) (BACnetConstructedDataCharacterStringValueFaultValues, error) {
	return BACnetConstructedDataCharacterStringValueFaultValuesParseWithBuffer(utils.NewReadBufferByteBased(theBytes), tagNumber, objectTypeArgument, propertyIdentifierArgument, arrayIndexArgument)
}
...
func (m *_BACnetConstructedDataCharacterStringValueFaultValues) SerializeWithWriteBuffer(writeBuffer utils.WriteBuffer) error {
